...
Route::middleware('auth')->group(function () {
    ...
    Route::resource('items', ItemController::class)->only(['index', 'store', 'destroy', 'update', 'show']);
    Route::resource('employee', EmployeeController::class)->only(['index', 'store', 'destroy', 'show', 'update']);
    Route::resource('issue', IssueItemController::class)->only(['index', 'show', 'store']);
    Route::resource('return', ReturnController::class)->only(['show', 'update']);
